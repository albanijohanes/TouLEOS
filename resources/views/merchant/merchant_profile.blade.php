        ...
        <form>
            <div class="row profile-row" style="padding-top: 0px;margin-top: 19px;">
                <div class="col-md-8" style="margin-right: 0px;padding-right: 0px;padding-left: 0px;margin-left: 0px;">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group mb-3"><label class="form-label" style="font-family: Poppins, sans-serif;font-weight: bold;">KTP (Kartu Tanda Penduduk)</label><input class="form-control" type="password" name="password" autocomplete="off" required=""></div>
                            <div class="form-group mb-3"><label class="form-label" style="font-family: Poppins, sans-serif;font-weight: bold;">SIB (Surat Ijin Ber-usaha)</label><input class="form-control" type="password" name="password" autocomplete="off" required=""></div>
                        </div>
                        <div class="col-sm-12 col-md-6">
