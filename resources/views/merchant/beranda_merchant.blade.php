...
<body>
            ...
            <div
                ...
                <div style="max-width: 350px;">
                    <h2 class="text-uppercase fw-bold"
                        style="font-size: 39px;padding-right: 0px;font-family: Poppins, sans-serif;">
                        Selamat datang
                    </h2>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <form method="POST" action="{{ route('tambah_dagang') }}"
                                                ...
                                                <div class="modal-footer"><button class="btn btn-dark"
                                                        style="width: 100%;background: rgba(105,72,45,0.9);"
                                                        type="submit">Tambah</button></div>
                                            </form>
                                        </div>
                                        <div class="col-lg-6 hide-ele">
                                            <img style="width: 100%;margin-top: 38px;"
                                                src="{{ asset ('merchantassets/img/20230712_124645.jpg') }}">
                                            ...
                                            <form data-bss-recipient="67b465af92ed4ffdcc0537eaadc6dd61"
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-dark"
                                                        style="width: 100%;background: rgba(105,72,45,0.9);font-size: 12px;font-family: Poppins, sans-serif;"
                                                        type="submit">
                                                        Simpan
                                                    </button>
                                                </div>
    ...
    <h1 style="text-align: center;font-size: 14px;font-family: Poppins, sans-serif;font-weight: bold;margin-top: 81px;">
        Riwayat</h1>
    <div class="row" style="text-align: center;">
        <div class="col-sm-12"
            style="font-size: 12px;font-family: Poppins, sans-serif;margin-bottom: 10px;margin-right: -38px;padding-right: 40px;">
            <select class="display-inline-block" style="padding-right: 0px;margin-right: 5px;">
