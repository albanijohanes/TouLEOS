...
<body
    ...
    <img src="{{ asset('landingassets/img/Logo%20web%20Tou%20Leos%20(3).png') }}"
        ...
        style="width: 180px;padding-bottom: 0px;padding-left: 31px;margin-left: -32px;">
    <h1
        style="text-align: center;color: #ffffff;font-family: Poppins, sans-serif;font-size: 63px;padding-top: 56px;margin-top: -52px;">
        Selamat datang !</h1>
    <div class="container" style="padding-top: 0px;margin-top: -116px;margin-bottom: 110px;padding-left: 0px;">
        <div class="row"
            style="margin-left: 68px;margin-right: 70px;margin-bottom: 142px;padding-top: 0px;margin-top: 132px;">
            <div class="col-sm-4 col-md-4">
                <div class="serviceBox yellow">
                    <div class="text-center service-icon"><a href="#"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="service-content" style="padding-top: 16px;font-family: Poppins, sans-serif;">
                        ...
                        style="padding-left: 20px;padding-right: 20px;margin-right: 20px;margin-left: 20px;margin-bottom: 5px;font-family: Poppins, sans-serif;font-size: 14px;">MASUK</button><button
                        class="btn btn-primary" type="button"
                        style="padding-left: 20px;padding-right: 20px;margin-right: 20px;margin-bottom: 5px;margin-left: 20px;font-family: Poppins, sans-serif;font-size: 14px;">DAFTAR</button>
                </div>
            </div>
            <div class="col-sm-4 col-md-4">
                <div class="serviceBox yellow">
                    ...
                    <div class="service-content" style="padding-top: 16px;">
                        ...
                        style="padding-left: 20px;padding-right: 20px;margin-left: 20px;margin-right: 20px;font-family: Poppins, sans-serif;">MASUK</button><button
                        class="btn btn-primary" type="button"
                        style="padding-left: 20px;padding-right: 20px;margin-left: 20px;margin-right: 20px;margin-bottom: 5px;font-family: Poppins, sans-serif;font-size: 14px;">DAFTAR</button>
                </div>
            </div>
            <div class="col-sm-4 col-md-4">
                <div class="serviceBox yellow">
                    ...
                    <div class="service-content" style="padding-top: 16px;font-family: Poppins, sans-serif;">
                        ...
                        style="padding-left: 20px;padding-right: 20px;margin-left: 20px;margin-right: 20px;font-family: Poppins, sans-serif;">MASUK</button><button
                        class="btn btn-primary" type="button"
                        style="padding-left: 20px;padding-right: 20px;margin-left: 20px;margin-right: 20px;margin-bottom: 5px;font-family: Poppins, sans-serif;">DAFTAR</button>
                </div>
            </div>
        </div>
    </div>
