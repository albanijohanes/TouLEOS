    ...
    <div id="wrapper">
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark" style="background: url(&quot;assets/img/Aldenaire%20&%20Partners.png&quot;) bottom;">
            <div class="container-fluid d-flex flex-column p-0">
                <img src="assets/img/Logo%20web%20Tou%20Leos%20(3).png" style="width: 70px;margin-right: 0px;padding-top: 14px;"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th style="font-family: Poppins, sans-serif;padding-left: 60px;padding-right: 65px;font-size: 14px;">
                            Nama
                        </th>
                        <th style="font-family: Poppins, sans-serif;font-size: 14px;padding-right: 50px;padding-left: 42px;">
                            Email
                        </th>
                        <th style="font-family: Poppins, sans-serif;text-align: center;font-size: 14px;padding-right: 25px;padding-left: 22px;">
                            No Handphone
                        </th>
                        <th style="font-family: Poppins, sans-serif;text-align: center;padding-left: 30px;padding-right: 26px;font-size: 14px;">
                            Jenis Kelamin
                        </th>
                        <th style="font-family: Poppins, sans-serif;text-align: center;font-size: 14px;padding-left: 20px;padding-right: 18px;">
                            Alamat
                        </th>
                        <th style="font-family: Poppins, sans-serif;text-align: center;padding-right: 32px;padding-left: 34px;font-size: 14px;">
                            KTP
                        </th>
                        <th style="font-family: Poppins, sans-serif;text-align: center;padding-right: 32px;padding-left: 34px;font-size: 14px;">
                            SIUP
